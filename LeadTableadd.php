...
// Create page object
$LeadTable_add = new LeadTable_add();
...
var fLeadTableadd = currentForm = new ew.Form("fLeadTableadd", "add");

// Validate form
fLeadTableadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($LeadTable_add->CustomerID->Required) { ?>
		...
		<?php if ($LeadTable_add->LeadType->Required) { ?>
		...
		<?php if ($LeadTable_add->SiteLocation->Required) { ?>
		...
		<?php } ?>
		<?php if ($LeadTable_add->Suburb->Required) { ?>
		...
		<?php } ?>
		<?php if ($LeadTable_add->ExpectedStart->Required) { ?>
		...
		<?php if ($LeadTable_add->DateTaken->Required) { ?>
		...
		<?php if ($LeadTable_add->TakenBy->Required) { ?>
		...
		<?php } ?>
		<?php if ($LeadTable_add->IsComplete->Required) { ?>
		...
		<?php if ($LeadTable_add->LeadComment->Required) { ?>
...
fLeadTableadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fLeadTableadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $LeadTable_add->showPageHeader(); ?>
<?php
$LeadTable_add->showMessage();
?>
<form name="fLeadTableadd" id="fLeadTableadd" class="<?php echo $LeadTable_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($LeadTable_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $LeadTable_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="LeadTable">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$LeadTable_add->IsModal ?>">
...
<?php if ($LeadTable->CustomerID->Visible) { // CustomerID ?>
	<div id="r_CustomerID" class="form-group row">
		<label id="elh_LeadTable_CustomerID" for="x_CustomerID" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->CustomerID->caption() ?><?php echo ($LeadTable->CustomerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->CustomerID->cellAttributes() ?>>
...
<?php if ($LeadTable->LeadType->Visible) { // LeadType ?>
	<div id="r_LeadType" class="form-group row">
		<label id="elh_LeadTable_LeadType" for="x_LeadType" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->LeadType->caption() ?><?php echo ($LeadTable->LeadType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->LeadType->cellAttributes() ?>>
...
<?php if ($LeadTable->SiteLocation->Visible) { // SiteLocation ?>
	<div id="r_SiteLocation" class="form-group row">
		<label id="elh_LeadTable_SiteLocation" for="x_SiteLocation" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->SiteLocation->caption() ?><?php echo ($LeadTable->SiteLocation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->SiteLocation->cellAttributes() ?>>
...
<?php if ($LeadTable->Suburb->Visible) { // Suburb ?>
	<div id="r_Suburb" class="form-group row">
		<label id="elh_LeadTable_Suburb" for="x_Suburb" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->Suburb->caption() ?><?php echo ($LeadTable->Suburb->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->Suburb->cellAttributes() ?>>
...
<?php if ($LeadTable->ExpectedStart->Visible) { // ExpectedStart ?>
	<div id="r_ExpectedStart" class="form-group row">
		<label id="elh_LeadTable_ExpectedStart" for="x_ExpectedStart" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->ExpectedStart->caption() ?><?php echo ($LeadTable->ExpectedStart->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->ExpectedStart->cellAttributes() ?>>
...
<?php if ($LeadTable->DateTaken->Visible) { // DateTaken ?>
	<div id="r_DateTaken" class="form-group row">
		<label id="elh_LeadTable_DateTaken" for="x_DateTaken" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->DateTaken->caption() ?><?php echo ($LeadTable->DateTaken->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->DateTaken->cellAttributes() ?>>
...
<?php if ($LeadTable->TakenBy->Visible) { // TakenBy ?>
	<div id="r_TakenBy" class="form-group row">
		<label id="elh_LeadTable_TakenBy" for="x_TakenBy" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->TakenBy->caption() ?><?php echo ($LeadTable->TakenBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->TakenBy->cellAttributes() ?>>
...
<?php if ($LeadTable->IsComplete->Visible) { // IsComplete ?>
	<div id="r_IsComplete" class="form-group row">
		<label id="elh_LeadTable_IsComplete" for="x_IsComplete" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->IsComplete->caption() ?><?php echo ($LeadTable->IsComplete->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->IsComplete->cellAttributes() ?>>
...
<?php if ($LeadTable->LeadComment->Visible) { // LeadComment ?>
	<div id="r_LeadComment" class="form-group row">
		<label id="elh_LeadTable_LeadComment" for="x_LeadComment" class="<?php echo $LeadTable_add->LeftColumnClass ?>"><?php echo $LeadTable->LeadComment->caption() ?><?php echo ($LeadTable->LeadComment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $LeadTable_add->RightColumnClass ?>"><div<?php echo $LeadTable->LeadComment->cellAttributes() ?>>
...
<?php
	if (in_array("LeadFileAssociation", explode(",", $LeadTable->getCurrentDetailTable())) && $LeadFileAssociation->DetailAdd) {
?>
...
<?php } ?>
<?php
	if (in_array("AssignmentTable", explode(",", $LeadTable->getCurrentDetailTable())) && $AssignmentTable->DetailAdd) {
?>
<?php if ($LeadTable->getCurrentDetailTable() <> "") { ?>
...
<?php } ?>
<?php if (!$LeadTable_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $LeadTable_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $LeadTable_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$LeadTable_add->showPageFooter();
if (DEBUG_ENABLED)
