...
// Create page object
$JobSessionTable_edit = new JobSessionTable_edit();

// Run the page
$JobSessionTable_edit->run();
...
$JobSessionTable_edit->Page_Render();
?>
...
var fJobSessionTableedit = currentForm = new ew.Form("fJobSessionTableedit", "edit");

// Validate form
fJobSessionTableedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($JobSessionTable_edit->SessionID->Required) { ?>
		...
		<?php } ?>
		<?php if ($JobSessionTable_edit->AssignmentID->Required) { ?>
		...
		<?php if ($JobSessionTable_edit->SessionTeam->Required) { ?>
		...
		<?php if ($JobSessionTable_edit->StartTimestamp->Required) { ?>
		...
		<?php if ($JobSessionTable_edit->FinishTimestamp->Required) { ?>
		...
		<?php if ($JobSessionTable_edit->ExpectedStart->Required) { ?>
		...
		<?php if ($JobSessionTable_edit->SessionComment->Required) { ?>
...
fJobSessionTableedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fJobSessionTableedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $JobSessionTable_edit->showPageHeader(); ?>
<?php
$JobSessionTable_edit->showMessage();
?>
<form name="fJobSessionTableedit" id="fJobSessionTableedit" class="<?php echo $JobSessionTable_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($JobSessionTable_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $JobSessionTable_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="JobSessionTable">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$JobSessionTable_edit->IsModal ?>">
...
<?php if ($JobSessionTable->SessionID->Visible) { // SessionID ?>
	<div id="r_SessionID" class="form-group row">
		<label id="elh_JobSessionTable_SessionID" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->SessionID->caption() ?><?php echo ($JobSessionTable->SessionID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->SessionID->cellAttributes() ?>>
...
<input type="hidden" data-table="JobSessionTable" data-field="x_SessionID" name="x_SessionID" id="x_SessionID" value="<?php echo HtmlEncode($JobSessionTable->SessionID->CurrentValue) ?>">
<?php echo $JobSessionTable->SessionID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($JobSessionTable->AssignmentID->Visible) { // AssignmentID ?>
	<div id="r_AssignmentID" class="form-group row">
		<label id="elh_JobSessionTable_AssignmentID" for="x_AssignmentID" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->AssignmentID->caption() ?><?php echo ($JobSessionTable->AssignmentID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->AssignmentID->cellAttributes() ?>>
...
<?php if ($JobSessionTable->SessionTeam->Visible) { // SessionTeam ?>
	<div id="r_SessionTeam" class="form-group row">
		<label id="elh_JobSessionTable_SessionTeam" for="x_SessionTeam" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->SessionTeam->caption() ?><?php echo ($JobSessionTable->SessionTeam->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->SessionTeam->cellAttributes() ?>>
...
<?php if ($JobSessionTable->StartTimestamp->Visible) { // StartTimestamp ?>
	<div id="r_StartTimestamp" class="form-group row">
		<label id="elh_JobSessionTable_StartTimestamp" for="x_StartTimestamp" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->StartTimestamp->caption() ?><?php echo ($JobSessionTable->StartTimestamp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->StartTimestamp->cellAttributes() ?>>
...
<?php if ($JobSessionTable->FinishTimestamp->Visible) { // FinishTimestamp ?>
	<div id="r_FinishTimestamp" class="form-group row">
		<label id="elh_JobSessionTable_FinishTimestamp" for="x_FinishTimestamp" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->FinishTimestamp->caption() ?><?php echo ($JobSessionTable->FinishTimestamp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->FinishTimestamp->cellAttributes() ?>>
...
<?php if ($JobSessionTable->ExpectedStart->Visible) { // ExpectedStart ?>
	<div id="r_ExpectedStart" class="form-group row">
		<label id="elh_JobSessionTable_ExpectedStart" for="x_ExpectedStart" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->ExpectedStart->caption() ?><?php echo ($JobSessionTable->ExpectedStart->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->ExpectedStart->cellAttributes() ?>>
...
<?php if ($JobSessionTable->SessionComment->Visible) { // SessionComment ?>
	<div id="r_SessionComment" class="form-group row">
		<label id="elh_JobSessionTable_SessionComment" for="x_SessionComment" class="<?php echo $JobSessionTable_edit->LeftColumnClass ?>"><?php echo $JobSessionTable->SessionComment->caption() ?><?php echo ($JobSessionTable->SessionComment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $JobSessionTable_edit->RightColumnClass ?>"><div<?php echo $JobSessionTable->SessionComment->cellAttributes() ?>>
...
<?php
	if (in_array("TeamTable", explode(",", $JobSessionTable->getCurrentDetailTable())) && $TeamTable->DetailEdit) {
?>
...
<?php } ?>
<?php
	if (in_array("CartTable", explode(",", $JobSessionTable->getCurrentDetailTable())) && $CartTable->DetailEdit) {
?>
<?php if ($JobSessionTable->getCurrentDetailTable() <> "") { ?>
...
<?php } ?>
<?php if (!$JobSessionTable_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $JobSessionTable_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $JobSessionTable_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$JobSessionTable_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$JobSessionTable_edit->terminate();
?>