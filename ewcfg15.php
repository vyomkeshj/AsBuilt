...
$PROJECT_ID = "{0F066488-51F4-4512-9E75-792816ED19E6}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "107.150.52.219", "port" => 3306, "user" => "vyomkesh", "pass" => "remoteConnect", "db" => "ASBuiltDbase", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "JobWorkerTable");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "JobWorkerID");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "Passcode");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`JobWorkerTable`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`JobWorkerID` = %u)");
