 ...
 * Page class
 */
class LeadTable_delete extends LeadTable
{
	...
	// Page object name
	public $PageObjName = "LeadTable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("LeadTablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("LeadTablelist.php"); // Return to list
			}
		}
	}
