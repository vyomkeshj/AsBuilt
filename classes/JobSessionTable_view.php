 ...
 * Page class
 */
class JobSessionTable_view extends JobSessionTable
{
	...
	// Page object name
	public $PageObjName = "JobSessionTable_view";
	...
	public function __construct()
	{
		...
		if (Get("SessionID") !== NULL) {
			$this->RecKey["SessionID"] = Get("SessionID");
			$keyUrl .= "&amp;SessionID=" . urlencode($this->RecKey["SessionID"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("SessionID") !== NULL) {
				...
				$this->RecKey["SessionID"] = $this->SessionID->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->SessionID->setQueryStringValue(Key(0));
				$this->RecKey["SessionID"] = $this->SessionID->QueryStringValue;
			} elseif (Post("SessionID") !== NULL) {
				$this->SessionID->setFormValue(Post("SessionID"));
				$this->RecKey["SessionID"] = $this->SessionID->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->SessionID->setFormValue(Route(2));
				$this->RecKey["SessionID"] = $this->SessionID->FormValue;
			} else {
				$returnUrl = "JobSessionTablelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "JobSessionTablelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "JobSessionTablelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupOtherOptions()
	{
		...
		// "detail_TeamTable"
		$item = &$option->add("detail_TeamTable");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("TeamTable", "TblCaption");
		...
		if ($GLOBALS["TeamTable_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'TeamTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(TABLE_SHOW_DETAIL . "=TeamTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar <> "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["TeamTable_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'TeamTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(TABLE_SHOW_DETAIL . "=TeamTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar <> "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["TeamTable_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'TeamTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(TABLE_SHOW_DETAIL . "=TeamTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar <> "")
				$detailCopyTblVar .= ",";
		...
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'TeamTable');
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
		...
		// "detail_CartTable"
		$item = &$option->add("detail_CartTable");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("CartTable", "TblCaption");
		...
		if ($GLOBALS["CartTable_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'CartTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(TABLE_SHOW_DETAIL . "=CartTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar <> "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["CartTable_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'CartTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(TABLE_SHOW_DETAIL . "=CartTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar <> "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["CartTable_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'CartTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(TABLE_SHOW_DETAIL . "=CartTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar <> "")
				$detailCopyTblVar .= ",";
		...
		$body = "<div class=\"btn-group btn-group-sm ew-btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'CartTable');
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("TeamTable", $detailTblVar)) {
				if (!isset($GLOBALS["TeamTable_grid"]))
					$GLOBALS["TeamTable_grid"] = new TeamTable_grid();
				if ($GLOBALS["TeamTable_grid"]->DetailView) {
					$GLOBALS["TeamTable_grid"]->CurrentMode = "view";
			...
			if (in_array("CartTable", $detailTblVar)) {
				if (!isset($GLOBALS["CartTable_grid"]))
					$GLOBALS["CartTable_grid"] = new CartTable_grid();
				if ($GLOBALS["CartTable_grid"]->DetailView) {
					$GLOBALS["CartTable_grid"]->CurrentMode = "view";
