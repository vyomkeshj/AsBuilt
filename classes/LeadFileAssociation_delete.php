 ...
 * Page class
 */
class LeadFileAssociation_delete extends LeadFileAssociation
{
	...
	// Page object name
	public $PageObjName = "LeadFileAssociation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("LeadFileAssociationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("LeadFileAssociationlist.php"); // Return to list
			}
		}
	}
