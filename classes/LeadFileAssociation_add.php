 ...
 * Page class
 */
class LeadFileAssociation_add extends LeadFileAssociation
{
	...
	// Page object name
	public $PageObjName = "LeadFileAssociation_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("MappingID") !== NULL) {
				...
				$this->setKey("MappingID", $this->MappingID->CurrentValue); // Set up key
			} else {
				$this->setKey("MappingID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "LeadFileAssociationview.php")
