 ...
 * Page class
 */
class LeadTable_view extends LeadTable
{
	...
	// Page object name
	public $PageObjName = "LeadTable_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("LeadID") !== NULL) {
				...
				$returnUrl = "LeadTablelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "LeadTablelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "LeadTablelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupOtherOptions()
	{
		...
		$item = &$option->add("detail_LeadFileAssociation");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("LeadFileAssociation", "TblCaption");
		...
		if ($GLOBALS["LeadFileAssociation_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'LeadFileAssociation')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(TABLE_SHOW_DETAIL . "=LeadFileAssociation")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar <> "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["LeadFileAssociation_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'LeadFileAssociation')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(TABLE_SHOW_DETAIL . "=LeadFileAssociation")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar <> "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["LeadFileAssociation_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'LeadFileAssociation')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(TABLE_SHOW_DETAIL . "=LeadFileAssociation")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar <> "")
				$detailCopyTblVar .= ",";
		...
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'LeadFileAssociation');
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
		...
		$item = &$option->add("detail_AssignmentTable");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("AssignmentTable", "TblCaption");
		...
		if ($GLOBALS["AssignmentTable_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'AssignmentTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(TABLE_SHOW_DETAIL . "=AssignmentTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar <> "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["AssignmentTable_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'AssignmentTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(TABLE_SHOW_DETAIL . "=AssignmentTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar <> "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["AssignmentTable_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'AssignmentTable')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(TABLE_SHOW_DETAIL . "=AssignmentTable")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar <> "")
				$detailCopyTblVar .= ",";
		...
		$body = "<div class=\"btn-group btn-group-sm ew-btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->allowList(CurrentProjectID() . 'AssignmentTable');
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("LeadFileAssociation", $detailTblVar)) {
				if (!isset($GLOBALS["LeadFileAssociation_grid"]))
					$GLOBALS["LeadFileAssociation_grid"] = new LeadFileAssociation_grid();
				if ($GLOBALS["LeadFileAssociation_grid"]->DetailView) {
					$GLOBALS["LeadFileAssociation_grid"]->CurrentMode = "view";
			...
			if (in_array("AssignmentTable", $detailTblVar)) {
				if (!isset($GLOBALS["AssignmentTable_grid"]))
					$GLOBALS["AssignmentTable_grid"] = new AssignmentTable_grid();
				if ($GLOBALS["AssignmentTable_grid"]->DetailView) {
					$GLOBALS["AssignmentTable_grid"]->CurrentMode = "view";
