 ...
 * Page class
 */
class UserAuthTable_add extends UserAuthTable
{
	...
	// Page object name
	public $PageObjName = "UserAuthTable_add";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("UserAuthTablelist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("UserAuthTablelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "UserAuthTablelist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "UserAuthTableview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// AccessLevel
		$this->AccessLevel->setDbValueDef($rsnew, $this->AccessLevel->CurrentValue, NULL, FALSE);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("UserAuthTablelist.php"), "", $this->TableVar, TRUE);
