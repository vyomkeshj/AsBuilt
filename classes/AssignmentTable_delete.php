 ...
 * Page class
 */
class AssignmentTable_delete extends AssignmentTable
{
	...
	// Page object name
	public $PageObjName = "AssignmentTable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("AssignmentTablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("AssignmentTablelist.php"); // Return to list
			}
		}
	}
