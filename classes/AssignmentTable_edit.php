 ...
 * Page class
 */
class AssignmentTable_edit extends AssignmentTable
{
	...
	// Page object name
	public $PageObjName = "AssignmentTable_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_AssignmentID")) {
				$this->AssignmentID->setFormValue($CurrentForm->getValue("x_AssignmentID"));
			}
		} else {
	...
	protected function validateForm()
	{
		...
		if (in_array("JobSessionTable", $detailTblVar) && $GLOBALS["JobSessionTable"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("JobSessionTable", $detailTblVar) && $GLOBALS["JobSessionTable"]->DetailEdit) {
						...
						$editRow = $GLOBALS["JobSessionTable_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("JobSessionTable", $detailTblVar)) {
				...
				if ($GLOBALS["JobSessionTable_grid"]->DetailEdit) {
					$GLOBALS["JobSessionTable_grid"]->CurrentMode = "edit";
					$GLOBALS["JobSessionTable_grid"]->CurrentAction = "gridedit";
