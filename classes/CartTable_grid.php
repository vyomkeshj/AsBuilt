 ...
 * Page class
 */
class CartTable_grid extends CartTable
{
	...
	// Page object name
	public $PageObjName = "CartTable_grid";

	// Grid form hidden field names
	public $FormName = "fCartTablegrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_SessionID") && $CurrentForm->hasValue("o_SessionID") && $this->SessionID->CurrentValue <> $this->SessionID->OldValue)
			return FALSE;
	...
	protected function loadFormValues()
	{
		...
		if (!$this->SessionID->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->SessionID->Visible = FALSE; // Disable update for API request
			else
				$this->SessionID->setFormValue($val);
		}
		$this->SessionID->setOldValue($CurrentForm->getValue("o_SessionID"));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->SessionID->EditValue = HtmlEncode($this->SessionID->CurrentValue);
	...
	protected function validateForm()
	{
		...
		if (!CheckInteger($this->SessionID->FormValue)) {
			AddMessage($FormError, $this->SessionID->errorMessage());
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// SessionID
			$this->SessionID->setDbValueDef($rsnew, $this->SessionID->CurrentValue, 0, $this->SessionID->ReadOnly);
	...
	protected function addRow($rsold = NULL)
	{
		...
		// SessionID
		$this->SessionID->setDbValueDef($rsnew, $this->SessionID->CurrentValue, 0, FALSE);
