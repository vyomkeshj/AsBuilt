 ...
 * Page class
 */
class CustomerTable_delete extends CustomerTable
{
	...
	// Page object name
	public $PageObjName = "CustomerTable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("CustomerTablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("CustomerTablelist.php"); // Return to list
			}
		}
	}
