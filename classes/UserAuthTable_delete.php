 ...
 * Page class
 */
class UserAuthTable_delete extends UserAuthTable
{
	...
	// Page object name
	public $PageObjName = "UserAuthTable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("UserAuthTablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("UserAuthTablelist.php"); // Return to list
			}
		}
	}
