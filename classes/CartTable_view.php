 ...
 * Page class
 */
class CartTable_view extends CartTable
{
	...
	// Page object name
	public $PageObjName = "CartTable_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Serial") !== NULL) {
				...
				$returnUrl = "CartTablelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "CartTablelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "CartTablelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
