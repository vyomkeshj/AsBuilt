 ...
 * Page class
 */
class UserAuthTable_view extends UserAuthTable
{
	...
	// Page object name
	public $PageObjName = "UserAuthTable_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("_UserId") !== NULL) {
				...
				$returnUrl = "UserAuthTablelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "UserAuthTablelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "UserAuthTablelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
