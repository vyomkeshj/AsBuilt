 ...
 * Page class
 */
class JobSessionTable_delete extends JobSessionTable
{
	...
	// Page object name
	public $PageObjName = "JobSessionTable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("JobSessionTablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("JobSessionTablelist.php"); // Return to list
			}
		}
	}
