 ...
 * Page class
 */
class UserAuthTable_edit extends UserAuthTable
{
	...
	// Page object name
	public $PageObjName = "UserAuthTable_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Passcode
			$this->Passcode->setDbValueDef($rsnew, $this->Passcode->CurrentValue, NULL, $this->Passcode->ReadOnly);
